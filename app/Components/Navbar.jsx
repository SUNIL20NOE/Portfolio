        ...
        <nav className="flex items-center justify-between max-w-6xl mx-auto w-[90%] py-4">
            ...
            <motion.a
             ...
             href="#"
              ...
              >
                sunil<span className='text-primary text-3xl'></span>
            </motion.a>
            {/* Navigation Links */}
            <motion.div
            initial={{opacity:0,x:-20}}
             ...
             className={`hidden min-[825px]:flex items-center gap-4 bg-base shadow-lg opacity-80 px-8 py-3 rounded-full ${
                ...
                {navLinks.map((link,index) => (
                    ...
                    href={link.href} 
                    className='text-content text-[15px] font-bold hover:text-content-alternate transition-all duration-300 ease-in-out'
                    >
                    {link.name}</motion.a>
                ))}
            </motion.div>
                 ...
                 <div className='flex flex-col gap-4'>
                  {navLinks.map((link,index) => (
                   ...
                   <a
                     ...
                     key={link.href || index}
                     href={link.href}
                     className='text-content text-[18px] font-bold hover:text-content-alternate py-3 border-b border-gray-100 transition-all duration-300 ease-in-out'
                   >
